...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <p>
        Total Stores:{{ bookstores.totalStroes }}
...
const allFamousWorks = computed(() => {
  ...
  return authors.flatMap((author) => author.allFamousWorks.map((work) => work.title))
})
/*
  const allFamousWorks = computed(() => {
  return authors.reduce((works, author) => {return works.concat(author.famoousWorks)}, [])
})
*/
